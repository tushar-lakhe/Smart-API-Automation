...
for i in dict3:
    if i["execution_flag"] == "Api" or i["execution_flag"] == "Both":
        ...
        try:
            if i["method"] == 'POST' and i["json_payload"] != "None" and i["layered_call"] == None:
                #print("POST Method")
            ...
            elif i["method"] == 'GET' and i["layered_call"] == None:
                #print("GET Method")
                file1 = open(testcases_api + i["test_case_id"] + ".feature", "w")
                file1.write('\nFeature: ' + i["test_case_id"] + ' ' + i["method"] + ' Request\n')
                file1.write('\n\tBackground:\n\t\t * configure report = { showLog: true, showAllSteps: false }\n\t\t')
            ...
            elif i["method"] == 'PUT' and i["json_payload"] != "None" and i["layered_call"] == None:
                #print("PUT Method")
                file1 = open(testcases_api + i["test_case_id"] + ".feature", "w")
                file1.write('\nFeature: ' + i["test_case_id"] + ' ' + i["method"] + ' Request\n')
                file1.write('\n\tBackground:\n\t\t * configure report = { showLog: true, showAllSteps: false }\n\t\t')
            ...
            elif i["method"] == 'DELETE' and i["layered_call"] == None:
                file1 = open(testcases_api + i["test_case_id"] + ".feature", "w")
                file1.write('\nFeature: ' + i["test_case_id"] + ' ' + i["method"] + ' Request\n')
                file1.write('\n\tBackground:\n\t\t * configure report = { showLog: true, showAllSteps: false }\n\t\t')
            ...
            elif i["method"] == 'POST' and i["layered_call"] != None:
                file1 = open(testcases_api + i["test_case_id"] + ".feature", "w")
                file1.write('\nFeature: ' + i["test_case_id"] + ' ' + i["method"] + ' Request\n')
                file1.write('\n\tBackground:\n\t\t* configure report = { showLog: true, showAllSteps: false }')
                file1.write('\n\t\t* def response = call read ("../api/rest_'+i["layered_call"]+'.feature")')
                file1.write('\n\t\t* def '+ i["test_case_id"] +' = response\n')
                method.post_method()
            ...
            elif i["method"] == 'PUT' and i["layered_call"] != None:
                file1 = open(testcases_api + i["test_case_id"] + ".feature", "w")
                file1.write('\nFeature: ' + i["test_case_id"] + ' ' + i["method"] + ' Request\n')
                file1.write('\n\tBackground:\n\t\t* configure report = { showLog: true, showAllSteps: false }')
                file1.write('\n\t\t* def response = call read ("../api/rest_'+i["layered_call"]+'.feature")')
